...
QT_MOC_LITERAL(1, 14, 16), // "sendLoginRequest"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5), // "login"
QT_MOC_LITERAL(4, 38, 8), // "password"
QT_MOC_LITERAL(5, 47, 19), // "handleAuthorization"
QT_MOC_LITERAL(6, 67, 21) // "onAuthorizationFailed"

    },
    "Authorization\0sendLoginRequest\0\0login\0"
    "password\0handleAuthorization\0"
...
void Authorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendLoginRequest((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->handleAuthorization(); break;
        case 2: _t->onAuthorizationFailed(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Authorization::sendLoginRequest)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Authorization::sendLoginRequest(const QString & _t1, const QString & _t2)
{
