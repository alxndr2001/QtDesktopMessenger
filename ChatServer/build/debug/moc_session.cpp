...
QT_MOC_LITERAL(1, 8, 18), // "clientDisconnected"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "Session*"
QT_MOC_LITERAL(4, 37, 7), // "session"
QT_MOC_LITERAL(5, 45, 11), // "sendMessage"
QT_MOC_LITERAL(6, 57, 8), // "QString&"
QT_MOC_LITERAL(7, 66, 4), // "from"
QT_MOC_LITERAL(8, 71, 2), // "to"
QT_MOC_LITERAL(9, 74, 7), // "message"
QT_MOC_LITERAL(10, 82, 11), // "onReadyRead"
QT_MOC_LITERAL(11, 94, 14) // "onDisconnected"

    },
    "Session\0clientDisconnected\0\0Session*\0"
    "session\0sendMessage\0QString&\0from\0to\0"
    "message\0onReadyRead\0onDisconnected"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clientDisconnected((*reinterpret_cast< Session*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Session::*)(Session * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::clientDisconnected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Session::*)(QString & , QString & , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::sendMessage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Session::clientDisconnected(Session * _t1)
{
...
// SIGNAL 1
void Session::sendMessage(QString & _t1, QString & _t2, QString _t3)
{
